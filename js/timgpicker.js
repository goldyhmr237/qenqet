;(function($, window, document, undefined) {
	...
	defaults = {
		...
		url: 'index.php?option=com_iconnect&view=ajaxcall&layout=upload_avatar&tmpl=tigraajax',
	...
	Plugin.prototype = {
		...
		// Reset everything
		reset: function() {$('#paction').removeClass('loaded');
			this.alert('', 'hide');
		...
		alert: function(message, messageType) {
	        ...
	        alert.html(message)
	            .removeClass(
	            	(messageType == 'success' ? 'iconn-alert-danger iconn-alert-warning' :
	            		messageType =='warning' || messageType == 'loading' ?
	            			'iconn-alert-danger iconn-alert-success' : 
	            				'iconn-alert-warning iconn-alert-danger')
	            )
	            .addClass('iconn-alert-'+ ( messageType == 'success' ? 'success' : 
	            			messageType =='warning' || messageType == 'loading' ?
	            				'warning' : 'danger')
